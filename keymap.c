 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_BSLS, KC_SLSH,
...
[_RAISE] = LAYOUT(
  ...
  _______,   _______,   _______,   _______,  _______,  _______,   _______, KC_RSFT,  KC_HOME, KC_END, KC_DEL,  _______, _______, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
